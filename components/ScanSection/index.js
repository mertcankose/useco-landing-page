...
const ScanSection = () => {
  ...
  return (
    <div
      id="scan"
      className="bg-main mx-auto flex flex-col py-36 mb-28 relative z-30"
      onMouseMove={(e) => runMove(e)}
    >
      {/*<div id="light" style={{left:left, top:top}} className="absolute w-96 h-96 bg-white z-20 rounded-full"></div>*/}
      <div className="c-large">
        <h4 className="text-white text-6xl sm:text-8xl font-bold text-center">
          Scan & Go!
        </h4>
        <p className="text-3xl sm:text-4xl text-white font-medium text-center mt-3 mb-7">
